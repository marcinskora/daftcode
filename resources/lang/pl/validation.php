...
return [
    /*
    |--------------------------------------------------------------------------
    | Validation Language Lines (https://github.com/Laravel-Lang/lang)
    |--------------------------------------------------------------------------
    |
    ...
    */
    ...
    'password'             => 'Hasło jest nieprawidłowe. Hasło powinno zawierać dużą i małą literę, cyfrę i znak specjalny.',
    ...
    */
    ...
    'price' => 'Format pola :attribute jest nieprawidłowy.',
    'nip' => 'Format pola :attribute jest nieprawidłowy.',
    'postal_code' => 'Format pola :attribute jest nieprawidłowy.',
    'percent' => 'Format pola :attribute jest nieprawidłowy. Dozwolone wartośś z zakresu od 0,01 do 100',
    'path' => 'Format pola :attribute jest nieprawidłowy.'
];